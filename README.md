...
Should change the dts file of rk3328-roc-cc.dtb, we have made one [here](https://github.com/makerbase-mks/MKS-PI/tree/main/dts_for_rotate_180), you can download it, and then:
- SSH to login to the PI shell  
